...
export const METRICS: MetricConfig[] = [
  ...
  {
    key: 'median_scroll',
    label: 'Profondeur de scroll médiane',
    format: 'percentage',
    color: '#3b82f6',
    previousColor: '#9ca3af',
  },
...
export const PERIOD_LABELS: Record<DatePreset, string> = {
  previous_30_minutes: '30 dernières minutes',
  today: "Aujourd'hui",
  yesterday: 'Hier',
  previous_7_days: '7 derniers jours',
  previous_14_days: '14 derniers jours',
  previous_28_days: '28 derniers jours',
  previous_30_days: '30 derniers jours',
  previous_90_days: '90 derniers jours',
  previous_91_days: '91 derniers jours',
  ...
  previous_12_months: '12 derniers mois',
