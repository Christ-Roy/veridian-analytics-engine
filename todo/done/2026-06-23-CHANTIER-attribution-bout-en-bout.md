...
> **MAJ 2026-06-23** : S1 (channel ingestion) + S2 (funnel) + S3 (conversions/canal) LIVRÉS et PROMUS PROD (commit 0f9d844, v10). S4 (attribution→CRM) livré par le chantier customisation (mapper générique). **RESTE : S5 — upload des conversions vers la Google Ads API** (l'engine expose ads.conversions, l'upload par le skill google-ads reste à câbler). Ce ticket reste ouvert pour S5 uniquement.
